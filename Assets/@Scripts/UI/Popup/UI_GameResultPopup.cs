...
public class UI_GameResultPopup : UI_Base
{
    ...
    void RefreshUI()
    {
        ...
        GetText((int)Texts.ResultStageValueText).text = "1 STAGE";
        GetText((int)Texts.ResultSurvivalTimeText).text = "Survival Time";
        GetText((int)Texts.ResultSurvivalTimeValueText).text = "14:23";
        GetText((int)Texts.ResultGoldValueText).text = $"{Managers.Game.Gold}";
        GetText((int)Texts.ResultKillValueText).text = $"{Managers.Game.KillCount}";
